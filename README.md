...
- Торговля криптовалютами и производными инструментами сопряжена с **высоким риском** и может привести к полной потере вложенных средств.
- Авторы и правообладатели **не несут ответственности** за любые убытки, упущенную выгоду или иной ущерб, возникший в результате использования данного ПО.
- Прошлые результаты бэктестов и симуляций **не гарантируют** будущей доходности.
- Используйте бота **на свой страх и риск**. Рекомендуется тестировать только на testnet и не вкладывать средства, потерю которых вы не можете себе позволить.
- Данный проект не является финансовой консультацией или инвестиционной рекомендацией.

---

## Содержание

- [Дисклеймер](#-дисклеймер-отказ-от-ответственности)
...
- [Contributions и контакты](#contributions-и-контакты)
...
## Contributions и контакты

**Приветствуются любые вклады в проект.** Если вы хотите помочь — добро пожаловать.

### Как внести вклад

- **Issues** — сообщайте об ошибках, предлагайте идеи, задавайте вопросы
- **Pull Requests** — приветствуются исправления, новые фичи, улучшения документации
- **Тесты** — добавление тестов для нового кода
- **Документация** — правки README, комментарии в коде
...
- **GitHub:** [github.com/berkenov/binance_bot](https://github.com/berkenov/binance_bot)
- **Issues:** [Создать issue](https://github.com/berkenov/binance_bot/issues)
